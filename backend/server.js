...
const adminContactRoutes = require('./src/routes/adminContacts');
const adminFollowUpRoutes = require('./src/routes/adminFollowUps');
const adminAttachmentRoutes = require('./src/routes/adminAttachments');
...
// Trust proxy (running behind Nginx)
...
app.use('/api/admin', adminAttachmentRoutes);
